...
export class MorphTo<TRelated extends Eloquent = Eloquent> extends Relation<TRelated> {
  ...
  constructor(
    ...
    const typeValue = (parent as any)[tCol];
    ...
    super(parent, relatedModel || (parent.constructor as typeof Eloquent));
  ...
  protected addConstraints(): void {
    ...
    const idValue = (this.parent as any)[idColumn];
  ...
  public async getResults(): Promise<TRelated | null> {
    const typeValue = (this.parent as any)[this.typeColumn];
    const idValue = (this.parent as any)[this.idColumn];
    ...
    return (relatedModel as any).query().where('id', idValue).first();
  }
