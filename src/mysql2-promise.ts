...
export const Connection = (mysql2Promise as any).Connection;
export const PoolConnection = (mysql2Promise as any).PoolConnection;
export const PromisePool = (mysql2Promise as any).PromisePool;
export const PromiseConnection = (mysql2Promise as any).PromiseConnection;
export const PromisePoolConnection = (mysql2Promise as any).PromisePoolConnection;
